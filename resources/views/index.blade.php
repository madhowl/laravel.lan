...
<head>
	...
	<title>Портал ППК - панель управления</title>
    ...
    <div class="wrapper theme-1-active pimary-color-gold">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top">
			<div class="mobile-only-brand pull-left">
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							<img class="brand-img" src="../img/logo123.png" alt=""/>
							<span class="brand-text">Портал ППК</span>
						</a>
					</div>
				</div>	
		...
		<div class="fixed-sidebar-left">
			<ul class="nav navbar-nav side-nav nicescroll-bar">
				...
				<li>
					<a class="active" href="javascript:void(0);" data-toggle="collapse" data-target="#dashboard_dr"><div class="pull-left"><i class="zmdi zmdi-landscape mr-20"></i><span class="right-nav-text">Обучение</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="dashboard_dr" class="collapse collapse-level-1">
						<li>
							<a href="">Провести урок</a>
						</li>
						<li>
							<a href="">Ведомость</a>
						</li>
						...
						<li>
							<a class="active-page" href="">Статистика</a>
						</li>
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#ecom_dr"><div class="pull-left"><i class="zmdi zmdi-shopping-basket mr-20"></i><span class="right-nav-text">Предметы</span></div><div class="pull-right"><span class="label label-gold">hot</span></div><div class="clearfix"></div></a>
					<ul id="ecom_dr" class="collapse collapse-level-1">
						<li>
							<a href="e-commerce.html">Панель управления</a>
						</li>
						<li>
							<a href="product.html">Добавить предмет</a>
						</li>
						<li>
							<a href="product-detail.html">Редактировать предмет</a>
						</li>
						<li>
							<a href="add-products.html">Список предметов</a>
						</li>
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#ui_dr"><div class="pull-left"><i class="zmdi zmdi-smartphone-setup mr-20"></i><span class="right-nav-text">Студенты</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#form_dr"><div class="pull-left"><i class="zmdi zmdi-edit mr-20"></i><span class="right-nav-text">Группы</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#table_dr"><div class="pull-left"><i class="zmdi zmdi-format-size mr-20"></i><span class="right-nav-text">Преподователи</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
				...
				<li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#icon_dr"><div class="pull-left"><i class="zmdi zmdi-iridescent mr-20"></i><span class="right-nav-text">Предметы</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
									...
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><span class="counter-anim">23</span></span>
												<span class="weight-500 uppercase-font block font-13">Всего учащихся</span>
											</div>
											<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
												<i class="icon-graduation data-right-rep-icon txt-light-grey"></i>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
												...
												<span class="weight-500 uppercase-font block">успеваемость</span>
											</div>
											<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
							...
							<div class="panel-body pa-0">
								<div class="sm-data-box">
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
												<span class="txt-dark block counter"><span class="counter-anim">8,054</span></span>
												<span class="weight-500 uppercase-font block">учебных часов</span>
											</div>
											<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
									...
									<div class="container-fluid">
										<div class="row">
											<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
												...
												<span class="weight-500 uppercase-font block">Выпускников</span>
											</div>
											<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
					...
					<div class="col-lg-9 col-md-6 col-sm-12 col-xs-12">
                        <div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Оценки учеников</h6>
								</div>
                                ...
                                <div class="panel-body">
									<ul class="flex-stat mb-10 ml-15">
										...
										<li class="text-left auto-width">
											<span class="block">Оборот</span>
											<span class="block txt-dark weight-500 font-18"><span class="counter-anim">324,222</span> руб.</span>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><span class="counter-anim">224</span></span>
													<span class="weight-500 uppercase-font block font-13">Персонал</span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="txt-dark block counter"><span class="counter-anim">143</span></span>
													<span class="weight-500 uppercase-font block">Академ. отпуск</span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left txt-light">
													<span class="block counter"><span class="counter-anim">873</span></span>
													<span class="weight-500 uppercase-font block">Учебных дисцеплин</span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
						...
						<div class="panel card-view">
							<div class="panel-heading small-panel-heading relative">
								<div class="pull-left">
									<h6 class="panel-title">Оборот Колледжа</h6>
								</div>
								<div class="clearfix"></div>
								...
								<div class="panel-body row pa-0">
									<div class="sm-data-box">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
													<span class="block"><i class="zmdi zmdi-trending-up txt-success font-18 mr-5"></i><span class="weight-500 uppercase-font">рост</span></span>
													<span class="txt-dark block counter"><span class="counter-anim">78,982</span></span>
												</div>
												<div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
